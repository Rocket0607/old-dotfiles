...
(setq doom-font (font-spec :family "SourceCodePro" :size 17)
                doom-variable-pitch-font (font-spec :family "SourceCodePro" :size 17))
;; Some functionality uses this to identify you, e.g. GPG configuration, email
;; clients, file templates and snippets.
(setq user-full-name "Rohit Koneru"
      user-mail-address "rohitkoneru2510@gmail.com")
...
(setq org-hide-emphasis-markers 5)
